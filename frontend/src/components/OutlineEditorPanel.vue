      ...
      <div class="page-editor-body" v-if="currentPage">
        ...
        <div class="editor-section">
          ...
          <div class="text-input-group">
            <label class="text-input-label">页面类型</label>
            <select class="text-input" v-model="currentPage.layout" @change="onLayoutChange">
        ...
        <!-- Page Image (Content pages only) -->
        <div class="editor-section" v-if="currentPage.layout === 'content' || currentPage.layout === 'image-text'">
          <div class="editor-section-header">
            <span class="editor-section-title">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Background & Logo (Content pages only, not cover) -->
        <div class="editor-section" v-if="currentPage.layout === 'content' || currentPage.layout === 'image-text'">
          <div class="editor-section-header">
            <span class="editor-section-title">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Content Bullets (Content pages only) -->
        <div class="editor-section" v-if="currentPage.layout === 'content' || currentPage.layout === 'image-text' || currentPage.layout === 'toc'">
          <div class="editor-section-header">
            <span class="editor-section-title">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/>
              </svg>
              {{ currentPage.layout === 'toc' ? '目录项' : '内容要点' }}
            </span>
          </div>
